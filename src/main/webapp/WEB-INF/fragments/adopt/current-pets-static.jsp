	...
	<div class="innards">
		<div id="currentPets">
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[0].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">
			...
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[1].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">
			...
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[2].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">
			...
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[3].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">
			...
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[4].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">
			...
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[5].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">
			...
			<div class="sub-module">
				...
				<div class="row grid2col">
					<div class="column">
						<label for="currentPets[6].hasVaccines">Is this pet
							current on its vaccines?</label>
						<div class="multi-option">

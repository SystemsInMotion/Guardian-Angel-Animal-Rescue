		...
		<c:choose>
			...
			<c:otherwise>
				<div class="row grid2col">
					<div class="column">
						<label for="pet.name">What's the name of the pet you wish
							to adopt?</label> <input type="text" name="pet.name">
					</div>
					<div class="column">
						<label for="pet.description">Brief description</label> <input
							type="text" name="pet.description">
					</div>
				</div>
			</c:otherwise>
		</c:choose>

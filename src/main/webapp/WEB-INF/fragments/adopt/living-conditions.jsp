...
<div class="module">
	...
	<div class="row">
		...
		<div class="minorElem">
			<label for="petLivingLocation">Outside</label> <input type="checkbox"
				name="petLivingLocation" value="outside">
		</div>
		<form:label for="petLivingLocation" path="petLivingLocation"
	...
	<c:if test="${isDog}">
		<div class="row ">
			...
			<div class="minorElemBigger">
				<label for="fencedYard">Partially fenced</label> <input type="radio"
					name="fencedYard" value="partial" class="required">
			</div>
			<div class="minorElemBigger">
		...
		<div class="row" id="howContainPetDiv">
			...
			<br>
			<input type="text" name="howContainPet" class="explanation required">
		</div>
	</c:if>
	<div class="row">
	...
	<div class="row">
		...
		<br>
		<input type="text" name="daytimeLocation" class="explanation required">
	</div>
	<div class="row">
		...
		<br>
		<input type="text" name="sleepLocation" class="explanation required">
	</div>
	<div class="row">
		...
		<br>
		<input type="text" name="destructiveBehavior"

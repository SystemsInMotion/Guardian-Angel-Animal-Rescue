...
<div class="module">
	...
	<div class="row">
		...
		<input type="text" name="zipCode" id="zipCode" class="zipcodeUS required">
	</div>
	<div class="row">
	...
	<div class="row">
		<form:label for="mobilePhone" path="mobilePhone" cssErrorClass="error">Mobile phone</form:label>
		<input type="text" name="mobilePhone" id="mobilePhone" class="phoneUS">
	</div>
	<div class="row">

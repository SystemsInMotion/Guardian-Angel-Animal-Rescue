 ...
 -->
	...
	<div class="module">
		<div class="row">
			<label>How many pets do you currently own? (Max 20)</label><input
				type="text" id="currentPetCount" name="currentPetCount"
				class="input2char" />
		</div>
	...
	<div class="module">
		<label>Name(s)/phone number(s) of Veterinarian(s) that you
			have used <i>(If we cannot verify the vet history of animals
				currently in the home with the information you are providing on this
				application, your application will be automatically denied).</i>
		</label>
		<hr>
		<div class="row grid2col">
			<div class="column">
	...
	<div class="module">
		<c:if test="${pet.animal eq 'CAT'}">
			<div class="row">
				<label>Do you plan on having ${pet.name} declawed?</label>
				<div class="multi-option">
					<input type="radio" name="declawed" value="front"> Yes, front only
				</div>
				<div class="multi-option">
					<input type="radio" name="declawed" value="all"> Yes, all four
				</div>
				<input type="radio" name="declawed" value="no"> No
			</div>
		</c:if>
		<div class="row">
			<label>Where will ${pet.name} be living?</label>
			<div class="multi-option">
				<input type="checkbox" name="livingLocation" value="inside">
				Inside
			</div>
			<div class="multi-option">
				<input type="checkbox" name="livingLocation" value="outside">
				Outside
			</div>
			Other <input type="text" name="livingLocation" class="explanation">
		</div>
		<div class="row grid2col">
			<div class="column">
				<label>Do you have a fenced yard?</label>
				<div class="multi-option">
					<input type="radio" name="fencedYard" value="partial"> Partially fenced
				</div>
				<div class="multi-option">
					<input type="radio" name="fencedYard" value="completely"> Completely fenced
				</div>
				<input type="radio" name="fencedYard" value="no"> No
			</div>
		</div>
		<div class="row" id="installFence">
			<label>Would you be willing to install a physical or electric fence?</label>
			<div class="multi-option">
				<input type="radio" name="installFence" value="electric"> Electric
			</div>
			<div class="multi-option">
				<input type="radio"
				name="installFence" value="physical"> Physical
			</div>
			<input type="radio" name="installFence" value="no"> No
		</div>
		<div class="row" id="howContained">
			<label>How will the animal be let outside and
				contained in your yard without a fence?</label> <input type="text" name="howContained"
				class="explanation">
		</div>
		<div class="row">
			<label>Approximately, how many hours would the animal be left
				alone during the day?</label> <input type="text" name="hoursAlone"
				class="input2char" class="explanation">
		</div>
		<div class="row">
			<label>Where will the animal stay when you are not at home
				(be specific)?</label> <input type="text" name="daytimeLocation"
				class="explanation">
		</div>
		<div class="row">
			<label>Where will the animal sleep (be specific)?</label> <input
				type="text" name="sleepLocation" class="explanation">
		</div>
		<div class="row">
			<label>How will you handle destructive behavior?</label> <input
				type="text" name="destructiveBehavior" class="explanation">
		</div>
		<div class="row">
			<label>Do you plan on attending obedience classes?</label> <input
				type="radio" name="obedienceClasses" value="true"> Yes <input
				type="radio" name="obedienceClasses" value="false"> No
		</div>
		<div class="row">
			<label>What will you do with the animal if you move?</label> <input
				type="text" name="moving" class="explanation">
		</div>
		<div class="row">
			<label>For what reason would you consider giving up the
				animal?</label> <input type="text" name="givingUpSituation"
				class="explanation">
		</div>
		<div class="row">
			<label>Please describe your ideal pet?</label> <input type="text"
				name="idealPet" class="explanation">
		</div>
		<div class="row">
			<label>How long have you been looking for a pet?</label> <input
				type="text" name="searchingLength" class="explanation">
		</div>
		<div class="row">
		...
		<div id="whereApplied">
			<div class="row">
				<label>Where else have you applied?</label><input type="text"
					name="whereApplied" class="explanation">
			</div>
			<div class="row">
				<label>What is the reason for not adopting from above?</label><input type="text"
					name="failedAdoptionReason" class="explanation">
			</div>
		</div>
	</div>
	...
	<div class="module">
		<div class="row">
			<label>Are you aware that rescue animals may have unknown
				medical and behavior history?</label>
			<div class="multi-option">
				<input type="radio" name="medicalAwareness" value="true">
				Yes
			</div>
			<input type="radio" name="medicalAwareness" value="false"> No
		</div>
		<div class="row">
			<label>Would you allow a GAAR volunteer to do a home visit before or upon adoption?</label>
			<div class="multi-option">
		...
		<div>
			...
			<ul class="circle">
				...
				<li>Submitting an application does not obligate you to adopt
					nor does it guarantee the animal will be adopted to you.</li>
				<li>Guardian Angel Animal Rescue does not work on a first come
					first serve basis. We collect applications on the animal in
					question and make a determination on where we think the animal will
					do best.</li>

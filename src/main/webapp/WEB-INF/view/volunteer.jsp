...
<div class="module">
	...
	<p>Please contact us through this website, if you are interested in
		helping us on Saturdays, with our rescue animals.&nbsp;</p>
...
<div class="module">
	...
	<p>It's also the hardest way of helping. It is hard giving up an
		animal that has been under your care for any amount of time. The love,
		time and care that goes into these animals makes it very difficult to
		give them up when they get adopted.&nbsp; A foster must understand
		that the only way to save and keep saving animals lives is to let go
		when the time arrives.&nbsp;</p>

	<p>Foster homes are always needed. Vet care is provided by GAAR. If
		you are interested in fostering an animal, please call us.</p>
...
<div class="module">
	...
	<p>
		<em>GAAR does not own a facility or shelter of our own. &nbsp;The
			foster home is an important stepping stone from the time the
			cat/kitten is rescued until he/she can be permanently adopted.</em>
	</p>

	<p>Before you decide to become a foster provider, it's a good idea
		to take stock of your situation and decide if fostering a cat is right
		for you.&nbsp; It can be a rewarding and fulfilling experience, and
		may be an ideal situation for families that are unable to make a
		long-term commitment to a pet cat. It helps if the whole family is
		dedicated to the process of fostering a cat, because each cat might be
		with you for several months. If you have a cat of your own, its
	...
	<p>Keep in mind that the cats coming to you may have been in a
		shelter or abandoned. &nbsp;These cats may be frightened, stressed, or
		poorly nourished and will need love and attention to help them become
		socialized. Some may need to be re-trained in using a litter pan or be
		coaxed to eat. You may need to administer medicine, or care for an
		older, special needs cat with diminished eyesight or hearing.&nbsp;</p>
	...
	<p>One of our challenges is taking in unweaned or orphaned kittens.
		Newborn kittens fragile and vulnerable and they'll be depending on you
		to take the place of their missing mother. For the first two weeks of
		life, before kittens even open their eyes, they are completely
		helpless. These responsibilities include keeping the kittens very warm
		and feeding them every two to three hours with a syringe and
		commercial kitten formula. Momma cats stimulate the bodily functions
		of elimination in their kittens by licking the anus and urinary tract
		opening: you'll have to replicate this function with a warm, wet
		terrycloth washcloth.</p>

	<p>Last but not least, fostering any cat comes with the risk that
		you'll become attached to your foster and will feel sadness or a sense
		of loss when it's time to let them go. As each one is adopted out,
		it's key to remember that you provided a safe haven to a homeless cat
		that is now going on to a safe and permanent home.</p>
	...
	<p>If you're interested in becoming a cat foster home, please
		...
		a home visit required at the time of the drop off of your first foster
		kitty!&nbsp;</p>
</div>

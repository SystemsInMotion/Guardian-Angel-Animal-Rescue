...
.pluginCommentFlyout{position:absolute;width:100%}
.pluginCommentFlyoutFull{width:450px;top:24px}
.pluginCommentFlyoutSmall{top:23px}
.pluginCommentFlyoutTiny{top:0}
.pluginCommentFlyoutFullBox{top:62px}
.pluginCommentFlyoutFullButton{top:20px}
...
.pluginCommentStripFull{width:100%}
...
.uiCloseButton{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v2/yo/x/4WSewcWboV8.png);background-repeat:no-repeat;height:15px;width:15px}
.uiCloseButtonSmall{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v2/yp/x/ogYrclupeJV.png);height:11px;margin-top:1px;width:11px}
.uiCloseButtonHuge{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v2/yp/x/ubIGOTIgUYc.png)}
.uiCloseButtonDark{background-position:left -16px}
.uiCloseButtonInverted{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v2/y8/x/33RpiRygxAr.png);background-position:left -16px}
...
.uiCloseButtonSmallInverted{background-position:left -12px;background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v2/yt/x/Vi-KTnbdMKr.png)}
...
AsyncLoaderLazy.load("https:\/\/s-static.ak.fbcdn.net\/rsrc.php\/v2\/yZ\/r\/BhMxim8B9PB.js");</script><script>ServerJSQueue.add({"require":[["lowerDomain"],["Primer"]]});</script></head><body class="plugin webkit win Locale_en_US"><div id="FB_HiddenContainer" style="position:absolute; top:-10000px; width:0px; height:0px;"></div><div class="pluginSkinLight"><div><table class="uiGrid pluginConnectButtonLayoutRoot" cellspacing="0" cellpadding="0"><tbody><tr><td class="vTop hCent"><div><form rel="async" ajaxify="/plugins/like/disconnect" method="post" action="https://www.facebook.com/plugins/like/disconnect" onsubmit="return window.Event &amp;&amp; Event.__inlineSubmit &amp;&amp; Event.__inlineSubmit(this,event)" id="ud9non21"><input type="hidden" name="fb_dtsg" value="AQBZERBI" autocomplete="off"><input type="hidden" autocomplete="off" name="href" value="http://www.gaarmichigan.org/"><input type="hidden" autocomplete="off" name="action" value="like"><input type="hidden" autocomplete="off" name="nobootload"><input type="hidden" autocomplete="off" name="iframe_referer" value="http://www.gaarmichigan.org/"><input type="hidden" autocomplete="off" name="ref"><div class="pluginConnectButton"><div class="pluginButton pluginButtonInline pluginConnectButtonDisconnected hidden_elem" title=""><div><button type="submit"><i class="pluginButtonIcon img sp_like sx_like_thumb"></i>Like</button></div></div><div class="pluginButton pluginButtonPressed pluginButtonInline pluginButtonX pluginConnectButtonConnected" title=""><div><button type="submit"><i class="pluginButtonIcon pluginButtonXOff img sp_like sx_like_ch"></i><i class="pluginButtonIcon pluginButtonXOn img sp_like sx_like_x" title=""></i></button>Like</div></div></div></form></div></td><td class="pls" style="width: 90%"><div style="padding-left: 19px;" class="uiIconText"><i class="img sp_like sx_like_fav" style="top: 0px;"></i><span id="ud9non22"><span>You and 138 others like this.</span> <a class="pluginCommentFlyoutPrompt hidden_elem" href="https://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.gaarmichigan.org%2F&layout=standard&colorscheme=light&show_faces=false&width=168&height=40&action=like#" target="_blank">Add a comment</a></span><span class="hidden_elem" id="ud9non23">138 people like this. Be the first of your friends.</span></div></td></tr></tbody></table><form rel="async" ajaxify="/plugins/like/comment" class="hidden_elem" method="post" action="https://www.facebook.com/plugins/like/comment" onsubmit="return window.Event &amp;&amp; Event.__inlineSubmit &amp;&amp; Event.__inlineSubmit(this,event)" id="ud9non26"><input type="hidden" name="fb_dtsg" value="AQBZERBI" autocomplete="off"><input type="hidden" autocomplete="off" name="href" value="http://www.gaarmichigan.org/"><input type="hidden" autocomplete="off" name="action" value="like"><input type="hidden" autocomplete="off" name="ref"><input type="hidden" autocomplete="off" name="nobootload"></form></div></div><script>function envFlush(a){function b(c){for(var d in a)c[d]=a[d];}if(window.requireLazy){requireLazy(['Env'],b);}else{Env=window.Env||{};b(Env);}}
envFlush({"fb_dtsg":"AQBZERBI","ajaxpipe_token":"AXjByM8uU_8kUgQH","lhsh":"iAQGt1gPp","user":"1075860147"});</script><script>
...
</script><div style="display: none; " id="hiddenlpsubmitdiv"></div><script>try{for(var lastpass_iter=0; lastpass_iter < document.forms.length; lastpass_iter++){ var lastpass_f = document.forms[lastpass_iter]; if(typeof(lastpass_f.lpsubmitorig2)=="undefined"){ lastpass_f.lpsubmitorig2 = lastpass_f.submit; lastpass_f.submit = function(){ var form=this; var customEvent = document.createEvent("Event"); customEvent.initEvent("lpCustomEvent", true, true); var d = document.getElementById("hiddenlpsubmitdiv"); for(var i = 0; i < document.forms.length; i++){ if(document.forms[i]==form){ d.innerText=i; } } d.dispatchEvent(customEvent); form.lpsubmitorig2(); } } }}catch(e){}</script><script>try{if (typeof(lpcurruser) == 'undefined') lpcurruser = ''; if (document.getElementById('lpcurruserelt') && document.getElementById('lpcurruserelt').value != '') { lpcurruser = document.getElementById('lpcurruserelt').value; document.getElementById('lpcurruserelt').value = ''; } if (typeof(lpcurrpass) == 'undefined') lpcurrpass=''; if (document.getElementById('lpcurrpasselt') && document.getElementById('lpcurrpasselt').value != '') { lpcurrpass = document.getElementById('lpcurrpasselt').value; document.getElementById('lpcurrpasselt').value = ''; } var lploc=1;var lponlyfill=1;function lastpass_fixfacebook(){if(document.location.href.indexOf("/plugins")!=-1){return;}if(document.getElementById("email")){document.getElementById("email").focus();}if(document.getElementById("pass_placeholder")){var ph=document.getElementById("pass_placeholder");if(ph.style.visibility!="hidden" && ph.style.display!="none"){try{ph.focus();}catch(err){}}}}lastpass_fixfacebook();setTimeout("lastpass_fixfacebook();", 500);lpcurruser = ''; lpcurrpass = '';}catch(e){}</script><script>try{if (typeof(lpcurruser) == 'undefined') lpcurruser = ''; if (document.getElementById('lpcurruserelt') && document.getElementById('lpcurruserelt').value != '') { lpcurruser = document.getElementById('lpcurruserelt').value; document.getElementById('lpcurruserelt').value = ''; } if (typeof(lpcurrpass) == 'undefined') lpcurrpass=''; if (document.getElementById('lpcurrpasselt') && document.getElementById('lpcurrpasselt').value != '') { lpcurrpass = document.getElementById('lpcurrpasselt').value; document.getElementById('lpcurrpasselt').value = ''; } var lploc=2;var lponlyfill=1;function lastpass_fixfacebook(){if(document.location.href.indexOf("/plugins")!=-1){return;}if(document.getElementById("email")){document.getElementById("email").focus();}if(document.getElementById("pass_placeholder")){var ph=document.getElementById("pass_placeholder");if(ph.style.visibility!="hidden" && ph.style.display!="none"){try{ph.focus();}catch(err){}}}}lastpass_fixfacebook();setTimeout("lastpass_fixfacebook();", 500);lpcurruser = ''; lpcurrpass = '';}catch(e){}</script></body><link rel="stylesheet" type="text/css" href="data:text/css,"></html>